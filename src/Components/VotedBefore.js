        ...
        <div className="security-box-voted-before">
          <p className="text-small">
            <strong>Security Feature:</strong><br />
                        This step ensures that you can update your vote. If this is your first time voting in this election, click "<strong>No</strong>" below. If you want to update your previous vote, click "<strong>Yes</strong>" below.    </p>
        </div>
